import{o as n,c as a,a2 as p}from"./index-ff1b7566.js";const e=""+new URL("logo-f7cd7373.svg",import.meta.url).href,l={class:"markdown-body"},r=p('<p><a href="https://nice-plq.github.io/vion/" target="_blank" rel="noopener noreferrer"><img width="200" src="'+e+`" alt="Vion logo"></a></p><br><p><a href="https://npmjs.com/package/vion"><img src="https://badgen.net/npm/v/vion"></a><img src="https://img.shields.io/badge/coverage-88.15%25-green"><img src="https://img.shields.io/badge/PR-welcome-brightgreen"></p><br><h2>特性</h2><ul><li>基于 Vue3 构建</li><li>30 个组件</li><li>完善的示例和文档说明</li><li>单元测试覆盖 88%</li><li>支持 tree-shaking</li><li>支持国际化</li><li>支持服务端渲染</li></ul><h2>快速上手</h2><h3>1、安装</h3><pre class="hljs"><code>tnpm install vion --save
...
<span class="hljs-keyword">const</span> app = createApp();
app.use(Icon);
</code></pre></div>`,21),o=[r],d={__name:"intro",setup(c,{expose:s}){return s({frontmatter:{}}),(t,u)=>(n(),a("div",l,o))}};export{d as default};
