import{o as a,c as n,a2 as t}from"./index-bfa72c3c.js";const l={class:"markdown-body"},p=t(`<h1>Tooltips</h1><p><img src="https://img.shields.io/badge/coverage-97.14%25-green" alt=""></p><hr><h4>1、基础用法</h4><p>常用于展示提示信息，通过<code>visible</code>控制气泡显示或隐藏，<code>placement</code>设置气泡的位置</p><div class="code-wrapper"><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div><pre><code class="hljs html"><span class="hljs-tag">&lt;<span class="hljs-name">v-tooltips</span>
