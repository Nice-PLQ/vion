import{o as n,c as a,a2 as p}from"./index-5ac088ad.js";const e={class:"markdown-body"},l=p(`<h2>特性</h2><ul><li>基于 Vue3 构建</li><li>88% 的单元测试覆盖</li><li>30 个组件</li><li>完善的示例和文档说明</li><li>支持 tree-shaking</li><li>支持国际化</li><li>支持服务端渲染</li></ul><h2>快速上手</h2><h3>1、安装</h3><pre class="hljs"><code>tnpm install vion --save
...
<span class="hljs-keyword">const</span> app = createApp();
app.use(Icon);
</code></pre></div>`,17),r=[l],d={__name:"intro",setup(o,{expose:s}){return s({frontmatter:{}}),(i,t)=>(n(),a("div",e,r))}};export{d as default};
